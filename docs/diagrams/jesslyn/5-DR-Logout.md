# User Story 5: Doctor Logout

**As a doctor, I want to log out safely and clear local session data so that unauthorized users cannot access the system.**
...
```
    Doctor      :Sidebar/TopBar          :auth.py              :LocalStorage
      │
      │ Click "Logout"
      │────────────────────>│
      │                     │
