# User Story 4: Doctor Login with OTP

**As a doctor, I want to log in using my userID, password, and a one-time verification code sent to my email so that my login is fully secured.**
...
```
    Doctor      :LoginPage    :VerificationPage    :auth.py      :UserAccount    :OTPStorage
      │
      │ Open page
      │────────────────────>│
      │                     │
