# User Story 6: Patient Reset Password

**As a patient, I want to reset my temporary password upon first login so that I can create a secure, personalized password for my account.**
...
```
    Patient     :ResetPasswordPage       :auth.py              :UserAccount
      │
      │ Open page
      │────────────────────>│
      │                     │
