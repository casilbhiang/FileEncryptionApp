...
const PMyFiles: React.FC = () => {
  ...
  const [files] = useState<FileItem[]>([
    ...
    { id: 4, name: 'Blood_Test_Result.Pdf', sharedBy: 'DR.Smith (Orthopaedics)', status: 'Shared', date: 'Last Edit May 3rd 2025' },
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar */}
      <Sidebar userRole="patient" currentPage="my-files" />
