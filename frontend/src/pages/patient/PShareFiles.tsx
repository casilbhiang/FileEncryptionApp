...
const PShareFiles: React.FC = () => {
  ...
  const doctors = [
    ...
    { id: 'dr2', name: 'Dr. Michael Chen', specialty: 'Orthopedics' },
    { id: 'dr3', name: 'Dr. Emily Brown', specialty: 'General Practice' },
  ];
  ...
  const handleShare = () => {
    console.log('Sharing files:', selectedFiles, 'to doctor:', selectedDoctor);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar */}
      <Sidebar userRole="patient" currentPage="share" />
      ...
      <div className="flex-1 p-4 lg:p-8 pt-16 lg:pt-8">
        ...
        <div className="bg-purple-50 rounded-lg p-6 lg:p-8 max-w-3xl">
          ...
          <div className="flex justify-center">
            <button
              onClick={handleShare}
              disabled={!selectedDoctor || selectedFiles.length === 0}
